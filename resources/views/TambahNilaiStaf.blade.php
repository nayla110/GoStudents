        ...
        <tbody>
          <tr>
            ...
            <td class="border border-black px-4 py-2">
              <input type="number" class="w-full p-2 border border-gray-400 rounded" placeholder="Masukkan nilai">
            </td>
          </tr>
          <tr>
          ...
          <tr>
            <td class="border border-black px-4 py-2">KIMIA</td>
            <td class="border border-black px-4 py-2">
              <input type="number" class="w-full p-2 border border-gray-400 rounded" placeholder="Masukkan nilai">
            </td>
          </tr>
          <tr>
            <td class="border border-black px-4 py-2">FISIKA</td>
            <td class="border border-black px-4 py-2">
              <input type="number" class="w-full p-2 border border-gray-400 rounded" placeholder="Masukkan nilai">
            </td>
          </tr>
